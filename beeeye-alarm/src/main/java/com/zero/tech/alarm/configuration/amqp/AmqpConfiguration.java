package com.zero.tech.alarm.configuration.amqp;

import com.zero.tech.alarm.listener.SyncRequestListener;
...
@ConditionalOnClass(com.zero.tech.data.rabbitmq.configuration.AmqpConfiguration.class)
