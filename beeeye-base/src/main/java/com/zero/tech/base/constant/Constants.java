package com.zero.tech.base.constant;
...
public class Constants {
    ...
    // mail
    public static final String MONITOR_APP_ALERT = "[app] 监控中心";
    public static final String MONITOR_MAIL_SUBJECT = "alarm app alert";
